...
{   
    ...
    float kaon_IPCHI2_OWNPV, kaon_TRACK_GhostProb,  proton_IPCHI2_OWNPV;
    float proton_TRACK_GhostProb,  muminus_ProbNNmu;
    float muminus_TRACK_GhostProb, muplus_ProbNNmu, muplus_TRACK_GhostProb, Lambda_b0_DTF_CHI2NDOF;
    float Lambda_b0_IPCHI2_OWNPV, Lambda_b0_PT;
    ...
    */
    ...
    double kaon_IPCHI2_OWNPVd, kaon_TRACK_GhostProbd,  proton_IPCHI2_OWNPVd;
    double proton_TRACK_GhostProbd, muminus_ProbNNmud;
    double muminus_TRACK_GhostProbd, muplus_ProbNNmud, muplus_TRACK_GhostProbd, Lambda_b0_DTF_CHI2NDOFd;
    double Lambda_b0_IPCHI2_OWNPVd, Lambda_b0_PTd; 
