void selectBackground(){ 
    ...
    const std::string filename = "/afs/cern.ch/work/a/apmorris/private/cern/ntuples/new_tuples/normalisation_samples/reduced_Lb2JpsipK_2011_2012_signal.root";//change
    
    const std::string treename("DecayTree");
    
    const std::string cuts = "Lambda_b0_DTF_MASS_constr1 > 5650";

    const std::string outFilename("/afs/cern.ch/work/a/apmorris/private/cern/ntuples/new_tuples/normalisation_samples/background.root");//change
