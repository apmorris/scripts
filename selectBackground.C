void selectBackground(){ 
    ...
    const std::string filename = "~/cern/ntuples/new_tuples/Lb2chicpK_2011_2012_signal_cut.root";//change
    const std::string treename("DecayTree");
    const std::string cuts = "Lambda_b0_DTF_MASS_constr1 > 5650";

    const std::string outFilename("~/cern/ntuples/new_tuples/background.root");//change
