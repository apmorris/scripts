/*	
	...
	Script to provide a graphical user interface
	in order to look at the results of  
	ZTMVAClassificationApplication.C
...
{   
   ...
   ActionButton( cbar,  
                 title,
                 ".x PlotFoams.C+(\"~/cern/weights/TMVAClassification_PDEFoam.weights_foams.root\")",
